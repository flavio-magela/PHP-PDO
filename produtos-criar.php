...
<?php else: ?>
            </br><p class = "text-danger">Nenhum Categoria Cadastrada no Sistema. Por favor cadastre pelo menos uma Categoria para o Cadastro de Produto funcionar. Obrigado!!!</p>
<?php endif ?>
